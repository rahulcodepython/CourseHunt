    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                <StatCard title="Total Enrolled" value="142" icon="IconUsers" />
                <StatCard title="Total Revenue" value="₹1,85,000" icon="IconCurrencyRupee" />
                <StatCard title="Average Rating" value="4.6" icon="IconStar" />
                <StatCard title="Completion Rate" value="68%" icon="IconPercentage" />
            </div>
                        ...
                        <TabsContent value="daily" className="mt-4">
                            <ResponsiveContainer width="100%" height={300}>
                                <BarChart data={dailyRevenue}>
                                    ...
                                    <YAxis tick={{ fontSize: 12, fill: "var(--muted-foreground)" }} axisLine={false} tickLine={false} tickFormatter={(value) => `₹${value / 1000}k`} />
                                    <Tooltip contentStyle={tooltipStyle} formatter={(value) => [`₹${Number(value ?? 0).toLocaleString("en-IN")}`, "Revenue"]} cursor={{ fill: "var(--muted)", opacity: 0.4 }} />
                        ...
                        <TabsContent value="enrollment" className="mt-4">
                            <ResponsiveContainer width="100%" height={300}>
                                <LineChart data={enrollments}>
                                    ...
                                    <Line type="monotone" dataKey="enrollments" stroke="hsl(var(--primary))" strokeWidth={2} dot={{ r: 3, fill: "hsl(var(--primary))" }} activeDot={{ r: 5 }} />
                                </LineChart>
                            </ResponsiveContainer>
                        </TabsContent>
                    </Tabs>
