...
INSERT INTO courses (
    ...
    benefits, requirements, category_id, coupon_allowed,
    total_lectures, total_duration_seconds, rating_avg, feedback_count, status
) VALUES
    (
        '55555555-5555-5555-5555-555555555501', '22222222-2222-2222-2222-222222222201', 'go-golang-microservices-masterclass',
        ...
        '44444444-4444-4444-4444-444444444412', true,
        25, 18000, 4.90, 18, 'published'
    ),
    (
        '55555555-5555-5555-5555-555555555502', '22222222-2222-2222-2222-222222222203', 'fullstack-nextjs-react-mastery',
        ...
        'Learn the latest Next.js 15 features including React Server Components (RSC), Server Actions, Parallel & Intercepting Routes, Turbopack, and full authentication integration.',
        ...
        '44444444-4444-4444-4444-444444444411', true,
        25, 21600, 4.85, 24, 'published'
    ),
    (
        '55555555-5555-5555-5555-555555555503', '22222222-2222-2222-2222-222222222201', 'system-design-distributed-systems',
        ...
        '44444444-4444-4444-4444-444444444420', true,
        25, 25200, 4.95, 32, 'published'
    ),
    (
        '55555555-5555-5555-5555-555555555504', '22222222-2222-2222-2222-222222222201', 'docker-kubernetes-modern-devops',
        ...
        '44444444-4444-4444-4444-444444444419', true,
        25, 19800, 4.80, 15, 'published'
    ),
    (
        '55555555-5555-5555-5555-555555555505', '22222222-2222-2222-2222-222222222202', 'python-data-science-machine-learning-bootcamp',
        ...
        '44444444-4444-4444-4444-444444444417', true,
        25, 23400, 4.92, 40, 'published'
    ),
    (
        '55555555-5555-5555-5555-555555555506', '22222222-2222-2222-2222-222222222202', 'deep-learning-llms-transformers-python',
        ...
        '44444444-4444-4444-4444-444444444418', true,
        25, 27000, 4.98, 28, 'published'
    ),
    (
        '55555555-5555-5555-5555-555555555507', '22222222-2222-2222-2222-222222222203', 'flutter-dart-multiplatform-mobile-dev',
        ...
        '44444444-4444-4444-4444-444444444415', true,
        25, 20500, 4.75, 19, 'published'
    ),
    (
        '55555555-5555-5555-5555-555555555508', '22222222-2222-2222-2222-222222222203', 'figma-ui-ux-design-system-mastery',
        ...
        '44444444-4444-4444-4444-444444444422', true,
        25, 16200, 4.88, 22, 'published'
    ),
    (
        '55555555-5555-5555-5555-555555555509', '22222222-2222-2222-2222-222222222201', 'rust-systems-programming-masterclass',
    ...
    (
        '55555555-5555-5555-5555-555555555510', '22222222-2222-2222-2222-222222222203', 'vue-nuxt3-modern-web-apps',
        ...
        '44444444-4444-4444-4444-444444444413', true,
