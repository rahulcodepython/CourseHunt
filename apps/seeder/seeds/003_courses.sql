...
INSERT INTO courses (
    ...
    (
        ...
        'go-golang-microservices-masterclass',
        ...
        (SELECT id FROM categories WHERE name = 'Golang & Backend'), true,
        25, 18000, 4.90, 18, 'published'
    ),
    (
        gen_random_uuid(),
        (SELECT id FROM users WHERE email = 'john.doe@example.com'),
        'fullstack-nextjs-react-mastery',
        ...
        (SELECT id FROM categories WHERE name = 'React & Next.js'), true,
    ...
    (
        ...
        (SELECT id FROM categories WHERE name = 'AWS & Cloud Architecture'), true,
    ...
    (
        ...
        (SELECT id FROM categories WHERE name = 'Machine Learning with Python'), true,
        25, 23400, 4.92, 40, 'published'
    ),
    (
        gen_random_uuid(),
        (SELECT id FROM users WHERE email = 'sarah.smith@example.com'),
        'deep-learning-llms-transformers-python',
        ...
        (SELECT id FROM categories WHERE name = 'Deep Learning & LLMs'), true,
        25, 27000, 4.98, 28, 'published'
    ),
    (
        gen_random_uuid(),
        (SELECT id FROM users WHERE email = 'john.doe@example.com'),
        'flutter-dart-multiplatform-mobile-dev',
        ...
        (SELECT id FROM categories WHERE name = 'Flutter & Dart'), true,
        25, 20500, 4.75, 19, 'published'
    ),
    (
        gen_random_uuid(),
        (SELECT id FROM users WHERE email = 'john.doe@example.com'),
        'figma-ui-ux-design-system-mastery',
        ...
        (SELECT id FROM categories WHERE name = 'Figma & Prototyping'), true,
        25, 16200, 4.88, 22, 'published'
    ),
    (
        gen_random_uuid(),
        (SELECT id FROM users WHERE email = 'tutor@example.com'),
        'rust-systems-programming-masterclass',
