...
type Chapter struct {
	...
	UnlockDaysAfterEnrollment int        `json:"unlock_days_after_enrollment" db:"unlock_days_after_enrollment"`
	UnlockAt                  *time.Time `json:"unlock_at" db:"unlock_at"`
	PrerequisiteChapterID     *string    `json:"prerequisite_chapter_id" db:"prerequisite_chapter_id"`
...
type CreateChapterRequest struct {
	...
	UnlockDaysAfterEnrollment *int       `json:"unlock_days_after_enrollment" validate:"omitempty,min=0"`
	UnlockAt                  *time.Time `json:"unlock_at"`
	PrerequisiteChapterID     *string    `json:"prerequisite_chapter_id" validate:"omitempty,uuid"`
}
