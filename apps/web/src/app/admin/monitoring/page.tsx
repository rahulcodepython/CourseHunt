      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 items-stretch">
        <Card className="flex flex-col justify-between h-full">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-base font-semibold">System Resource Telemetry</CardTitle>
          ...
          <CardContent className="flex flex-col justify-between flex-1 space-y-4 pt-2">
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="space-y-1.5 rounded-lg border p-2 bg-muted/20">
                ...
                {snapshot && (
                  <p className="text-[10px] text-muted-foreground">
                    {formatBytes(snapshot.telemetry.memory_used_bytes)} /{" "}
                    {formatBytes(snapshot.telemetry.memory_total_bytes)}
                  </p>
                )}
              </div>
              ...
              <div className="space-y-1.5 rounded-lg border p-2 bg-muted/20">
                ...
                {snapshot && (
                  <p className="text-[10px] text-muted-foreground">
                    {formatBytes(snapshot.telemetry.disk_used_bytes)} /{" "}
                    {formatBytes(snapshot.telemetry.disk_total_bytes)}
                  </p>
                )}
              </div>
            </div>
        ...
        <Card className="flex flex-col justify-between h-full">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-base font-semibold">Service Health Overview</CardTitle>
