...
function AddResourceDialog({
    ...
    const [pendingFile, setPendingFile] = React.useState<{ url: string; fileType: string } | null>(null);
        ...
        >
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 overflow-hidden min-w-0 w-full">
                ...
                <DialogFooter>
                    ...
                    <LoadingButton type="submit" disabled={!pendingFile?.url} loading={addResourceMutation.isPending}>
                        Add Resource
                    </LoadingButton>
                </DialogFooter>
            </form>
