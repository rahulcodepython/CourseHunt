    ...
    <Card>
      <CardHeader>
        ...
        <p className="text-sm text-muted-foreground">
          Add an authenticator app (Google Authenticator, Authy, etc.) as a second verification step
          whenever you sign in with your email or Google.
        </p>
      </CardHeader>
        ...
        {step === "idle" && (
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              />
              <span className="text-sm font-medium">{enabled ? "Enabled" : "Not enabled"}</span>
            </div>
            {enabled ? (
          ...
          <div className="space-y-4">
            <div className="flex flex-col items-center gap-3 rounded-lg border p-4">
              ...
              <p className="text-center text-xs text-muted-foreground">
                Scan this with your authenticator app, then enter the 6-digit code it shows below.
              </p>
            </div>
            ...
            {backupCodes.length > 0 && (
              <div className="rounded-lg border border-amber-500/30 bg-amber-500/5 p-3">
                <p className="mb-2 text-xs font-medium text-amber-600">
                  Save these backup codes — each can be used once if you lose your device. They
