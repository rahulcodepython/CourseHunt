...
export function AppSidebar({ navGroups, brandTitle, brandSubTitle, brandLogo }: AppSidebarProps) {
                    ...
                    <SidebarMenuItem>
                      <CollapsibleTrigger asChild>
                        <SidebarMenuButton tooltip={item.title}>
                          ...
                          <Icon
                            name="chevron-right"
                            className="ml-auto size-4 shrink-0 transition-transform duration-200 group-data-[state=open]/collapsible:rotate-90 group-data-[collapsible=icon]:hidden"
                          />
                        </SidebarMenuButton>
                      </CollapsibleTrigger>
                      <CollapsibleContent>
