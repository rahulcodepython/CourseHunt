...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <Icon name="IconChevronDown" data-slot="accordion-trigger-icon" className="pointer-events-none shrink-0 group-aria-expanded/accordion-trigger:hidden" />
        <Icon name="IconChevronUp" data-slot="accordion-trigger-icon" className="pointer-events-none hidden shrink-0 group-aria-expanded/accordion-trigger:inline" />
      </AccordionPrimitive.Trigger>
