...
import { useSimpleMutation, usePaginatedMutation, appendToPaginated, removeFromPaginated } from "@/react-query/mutation";
...
export function useWishlistQuery() {
	return useAppQuery(queryKeys.wishlist(), () =>
		apiRequest({ url: API_ENDPOINTS.WISHLIST, method: "GET" }, PaginatedResponseZod(WishlistItemZod)),
	);
}
