...
CREATE INDEX IF NOT EXISTS idx_discussions_course_user   ON discussions(course_id, user_id);
CREATE INDEX IF NOT EXISTS idx_discussions_depth         ON discussions(depth);
