...
export default function CourseSingle({ params }: { params: Promise<{ _id: string }> }) {
    ...
    const { data: course, isLoading } = usePublicCourseSingleQuery(_id)

    const testimonials = [
        {
            name: "Sarah Johnson",
            role: "Frontend Developer at Google",
            content: "This course completely transformed my career. The instructor explains complex concepts in a way that's easy to understand, and the projects are incredibly practical.",
        ...
        },
        {
            ...
            content: "Best web development course I've ever taken. The curriculum is up-to-date and covers everything you need to know to become a professional developer.",
            avatar: "/placeholder.svg?height=40&width=40",
            rating: 5,
        },
        {
            ...
            content: "The hands-on approach and real-world projects make this course stand out. I landed my dream job just 3 months after completing it!",
            avatar: "/placeholder.svg?height=40&width=40",
            rating: 5,
        },
    ]
                            ...
                            <div className="lg:col-span-1">
                                <Card className="sticky top-4 py-0">
                                    <CardContent className="p-6">
                                        ...
                                        <div className="text-center text-sm text-muted-foreground mt-2">30-day money-back guarantee</div>
                                    </CardContent>
                                </Card>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-2 space-y-12">
                            ...
                            <section>
                                ...
                                <div className="mb-4 text-sm text-muted-foreground">
                                    {course.chaptersCount} sections • {course.lessonsCount} lectures • {course.duration} total length
                                </div>
